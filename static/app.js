  ...
  .then((data) => {
    ...
    data.forEach((station) => {
      ...
      Circle.addListener("click", () => {
        document.getElementById("content").innerHTML = `<h1>${station.name}<h1>
        ...
        <p class="popupText">Bikes available: ${station.available_bikes} </p>
        </br>
        ...
        <p class="popupText">Spaces available: ${station.available_bike_stands}</p>`;
        popup = new Popup(
